...
object Utils {
  ...
  logger.info( System.currentTimeMillis() + " ### LOADING UTILS CLASS ###");
  ...
  /** Create spark conf */
  logger.info( System.currentTimeMillis() + " ### LOADING DEFAULT CONFIG ###");
  val conf  = new SparkConf().setAppName(System.getProperty("obspn.application.appname"))
  if( master == "local" ){
    logger.info( System.currentTimeMillis() + " ### SET SPARK LOCAL MODE ###");
    conf.setMaster("local")
  } 
  
  /** Create spark context */
  val sc = new SparkContext(conf)
  logger.info( System.currentTimeMillis() + " ### CREATE SPARK CONTEXT ###");
  
  /** Create hive context */
  val sqlContext = new HiveContext(sc)
  logger.info( System.currentTimeMillis() + " ### CREATE HIVE CONTEXT ###");
  ...
  def loadLocalConf(pathToConf: String): Config = {
    ...
    logger.info( System.currentTimeMillis() + " ### LOADING CONFIG FROM LOCAL ###");
    
    val confFile = new File( pathToConf)
    logger.info( System.currentTimeMillis() + " local = " + confFile.getAbsolutePath);
    
    logger.debug( System.currentTimeMillis() + " loading local config");
  ...
  def loadRemoteConf(pathToConf: String): Config = {
    ...
    logger.info( System.currentTimeMillis() + " ### LOADING CONFIG FROM HDFS ###");
    
    logger.info( System.currentTimeMillis() + " remote = " + pathToConf);
    ...
    logger.info( System.currentTimeMillis() + " copy config to local");
